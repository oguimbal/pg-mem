...
| this fork          |   374 KB |  97.9 KB |
| **delta**          | **+120 KB** | **+33.4 KB (+52%)** |
...
generate_series over timestamps, and the regexp_matches / regexp_split_to_array /
regexp_split_to_table functions).
