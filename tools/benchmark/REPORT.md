...
| this fork          |   380 KB | 100.6 KB |
| **delta**          | **+126 KB** | **+36.1 KB (+56%)** |
...
width_bucket and the bitwise/exponent operators, and quote_ident/quote_literal /
generate_subscripts / make_timestamp / make_time).
