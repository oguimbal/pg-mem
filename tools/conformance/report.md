...
**Score: 81/94 (86.2%)** — verified against differential (postgres://***@localhost:5433/postgres)
...
| window-functions | 5/6 | 0 | 0 | 0 | 1 | 0 |
| recursive-cte | 2/3 | 0 | 0 | 0 | 1 | 0 |
| joins | 4/4 | 0 | 0 | 0 | 0 | 0 |
| numeric-types | 2/6 | 4 | 0 | 0 | 0 | 0 |
| datetime-tz | 1/3 | 0 | 0 | 0 | 0 | 2 |
| triggers | 0/1 | 0 | 0 | 0 | 1 | 0 |
| transactions | 0/2 | 0 | 0 | 0 | 2 | 0 |
...
- `window frame rows between` — **parse-error**: 💔 Your query failed to parse.

### recursive-cte

- `recursive cte without column list` — **parse-error**: 💔 Your query failed to parse.
...
- `savepoint rollback` — **parse-error**: 💔 Your query failed to parse.
