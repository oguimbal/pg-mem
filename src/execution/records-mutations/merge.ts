import { _ITable, _Transaction, _ISelection, _IStatement, _IStatementExecutor, StatementResult, asTable, QueryError, nil, IValue, Row, getId } from '../../interfaces-private';
import { MergeStatement, MergeAction, Expr } from 'pgsql-ast-parser';
...
import { createSetter, Setter } from './mutation-base';
