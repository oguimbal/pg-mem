import { _ISchema, _Transaction, _ITable, _IStatementExecutor, asTable, StatementResult, _IStatement } from '../../interfaces-private';
import { CreatePolicyStatement, DropPolicyStatement } from 'pgsql-ast-parser';
