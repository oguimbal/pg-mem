import { _ISchema, _Transaction, _IStatementExecutor, _IStatement, asIndex, NotSupported } from '../../interfaces-private';
import { AlterIndexStatement } from 'pgsql-ast-parser';
