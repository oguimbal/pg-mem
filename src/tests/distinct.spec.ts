...
describe('Distinct', () => {
    ...
    it('select distinct columns', () => {
        expect(
            many(`create table data(a text, b text);
    ...
    it('select distinct does not consider hidden values', () => {
        expect(
            many(`create table data(a text, b text, c text);
    ...
    it('behaves nicely with nulls on multiple distinct', () => {
        expect(
            many(`create table test(v jsonb, i int);
