...
describe('Updates', () => {
    ...
    it('rollbacks in case of update failure', () => {
        ...
        expect(many(`select * from test`)).to.deep.equal([
            { key: 'a', val: 1 },
            { key: 'x', val: 2 },
            { key: 'a', val: 3 },
        ]);
    ...
    it('can update', () => {
        ...
        expect(
            many(`update data set str='something new';
    ...
    it('can update multiple', () => {
        expect(
            many(`create table test(key text, val integer);
                    insert into test values ('a', 1), ('x', 2), ('a', 3);
    ...
    it('can handle bool update', () => {
        expect(
            many(`create table test(val boolean);
