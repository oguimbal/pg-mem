...
describe('Count', () => {
    ...
    it('selects simple count', () => {
        expect(
            one(`create table test(val text);
    ...
    it('counts nulls the right way', () => {
        expect(
            one(`create table test(val int, val2 int);
    ...
    it('counts on group by the right way', () => {
        expect(
            many(`create table test(val int, val2 int);
                        insert into test values (1, null), (null, 1), (1, 1), (2, 3), (null, null);
    ...
    it('can use index on expression to count', () => {
        preventSeqScan(db);
        expect(
            many(`create table test(a int, b int);
    ...
    it('count on empty selection', () => {
        expect(
            one(`create table test(id int, val text);
    ...
    it('can count distinct multiple value', () => {
        expect(
            one(`create table test(a int, b int);
