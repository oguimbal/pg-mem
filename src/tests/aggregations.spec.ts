...
describe('Aggregations', () => {
    ...
    it('supports max()', () => {
        expect(
            many(`create table example(a int);
    ...
    it('supports sum() in inner expression (grouped by)', () => {
        expect(
            many(`create table example(id text, a int);
    ...
    it('throws error when aggregation function doest not exist', () => {
        ...
        assert.throws(
            () => none(`select public.sum(a) from example`),
            /function public\.sum\(integer\) does not exist/,
        );
    });
    ...
    it('does not return anything when no rows', () => {
        expect(
            many(`create table test(id text, a int);
